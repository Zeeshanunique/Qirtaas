            ...
            <div className="relative h-[400px]">
              {imageErrors[book.id] ? (
                ...
                <Image
                  ...
                  quality={75}
                  placeholder="blur"
                  blurDataURL="data:image/jpeg;base64,"
                />
              )}
            </div>
            <div className="p-6">
